...
<div class="main-heading-content col-md-12 col-sm-12 text-left">
		...
		<h2 style="color:rgb(6,89,67)"><i class="fa fa-user-plus" aria-hidden="true"></i><br><br> <br>CREATE NEW USER ACCOUNT</h2>
			<br>
			<h2 class="text-success"><i class="fa fa-user-plus" aria-hidden="true"></i><br><br> <br>CREATE NEW USER ACCOUNT</h2>
			<br>
			<table cellpadding='10' class="adi" >
				<strong class="text-success"><br><br><br>ENTER LOGIN DETAILS<br><br></strong>
				<tr>
					<td>Enter a valid username  </td>
					<td><input type="text" s name="username" required><br><br></td>
				</tr>
				<tr>
			...
			<br>
			<table cellpadding='10' class="adi" >
				<strong class="text-success">ENTER CUSTOMER'S PERSONAL DETAILS<br><br></strong>
				<tr>
				...
				<tr>
					...
					<td><input type="tel" pattern="[0-9]{10}" name="phone_no"  required><br><br></td>
				</tr>
				<tr>
