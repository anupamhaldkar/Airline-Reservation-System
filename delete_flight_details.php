...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>Delete Flight Schedule dates</title>
...
<div class="preloader">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-left">
		<form action="delete_flight_details_form_handler.php" method="post">
			<h2 style=color:black;><strong>ENTER THE FLIGHT SCHEDULE TO BE DELETED</strong><br><br></h2>
			<div>
			<?php
			...
			<table cellpadding="5" style="padding-left: 20px;">
				<tr class="adddi">
					...
					<td class="fix_table">Enter the Departure Date<br><br></td>
				</tr>
				<br>
				<tr>
