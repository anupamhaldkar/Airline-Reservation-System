...
<div class="preloader">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-left">
		...
		<h2 style="color:green">BOOKING SUCCESSFUL</h2><br><br>
		<h3 style="color:black"><b>Your payment of &#x20b9; <?php echo $_SESSION['total_amount']; ?> has been received.<br><br> Your PNR is <strong><?php echo $_SESSION['pnr'];?></strong>. Your tickets have been booked successfully.</h3>
