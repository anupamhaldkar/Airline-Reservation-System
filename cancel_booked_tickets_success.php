...
<link rel="stylesheet" type="text/css" href="css/color/rose.css">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-left">
		<h2 style=color:black;><b>CANCEL BOOKED TICKETS</b></h2><br>
		<h3 style='padding-left: 40px; color:black'><b>Your ticket has been cancelled successfully.<br><br>Your amount of &#x20b9; <?php echo $_SESSION['refund_amount']?> will be refunded to your bank account (Cancellation charge on 15% of your ticket amount has been deducted).</td>
		</b></h3>
		<br>
