...
<div class="preloader">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-center">
		<form action="add_jet_details_form_handler.php" method="post"><br>
	<br><br><br>
			<h2 style=color:rgb(255,99,71);><br><br><br><br>ENTER THE AIRCRAFTS DETAILS</h2><br><br>
			<div class="adi">
			<?php
			...
			<table cellpadding="5" class="adi">
				<tr>
					<td class="fix_table adddi">Enter a valid Jet ID (e.g. 12345)</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="number" style="color:black" name="jet_id" required></td>
				</tr>
			</table>
			<br>
			<table cellpadding="5" class="adi">
				<tr>
					<td class="fix_table adddi">Enter the Jet Type/Model</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="text" style="color:black" name="jet_type" required></td>
				</tr>
			</table>
			<br>
			<table cellpadding="5" class="adi">
				<tr>
					<td class="fix_table adddi">Enter the total capacity of the Jet</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="number" style="color:black" name="jet_capacity" required></td>
				</tr>
			</table>
			<br>
			<br>
