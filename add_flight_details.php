...
<div class="preloader">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-left"><br><br><br>
	<br><br><br><br><br><br><br><br><br><br>
		<form action="add_flight_details_form_handler.php" method="post">
			<br><br><br><h2 style="color:#00bfff">ENTER THE FLIGHT SCHEDULE DETAILS<br><br></h2>
			<?php
			...
			<table cellpadding="5" class="adddi">
				<tr>
					<td class="fix_table">Flight Number(e.g. AA105)<br></td>
				</tr>
				<tr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table adddi">Jet ID(5 digits)</td>
				</tr>
				<tr>
					<td class="fix_table">
						<input type="text" name="jet_id" required>
						<input type="submit" style="color:cyan;" value="Submit" name="Submit">
					</td>
				</tr>
			</table>
