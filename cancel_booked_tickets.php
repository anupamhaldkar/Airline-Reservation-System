...
<div class="preloader">
	...
	<div class="main-heading-content col-md-12 col-sm-12 text-center">
		<form action="cancel_booked_tickets_form_handler.php" method="post">
			...
			?>
			<table cellpadding="5" class="rtd" style="padding-left: 30px";>
				<tr>
					<td class="fix_table" style=color:black;>Enter the PNR</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="text" style=color:black; name="pnr" required></td>
				</tr>
			</table>
			<br>
